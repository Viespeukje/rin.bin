...
const AllowedRoles = ["Butch", "Tomboy", "Uncharted", "Male", "Female", "Femboy", "Trap", "Nonbinary", "Trans", "Genderfluid", "Futa", "Straight", "Bisexual", "Bicurious", "Gay", "Lesbian", "Asexual", "Pansexual", "Kinkster", "Innocent", "Dom", "Sub", "Switch", "F", "D", "NH", "K", "Porn", "Events", "RPG"]
const AssignedRoles = []
